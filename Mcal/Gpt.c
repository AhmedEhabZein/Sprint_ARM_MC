...
/* Global pointer to function to be used in Call Back */

static void (*g_SysTick_Call_Back_Ptr)(void) = NULL_PTR;

/************************************************************************************
* Service Name: SysTick_Handler
* Description: ISR of the SysTick Timer
************************************************************************************/
...
{
    SYSTICK_CTRL_REG    = 0;                         /* Disable the SysTick Timer by Clearing the ENABLE Bit */
    SYSTICK_RELOAD_REG  = 15999 * Tick_Time;         /* Set the Reload value to count in miliseconds */
    SYSTICK_CURRENT_REG = 0;                         /* Clear Current Register value */
